...
% -------------------------------------------------------------
%
% create a 2D trumpet plot (timeline plot)

function [offset,allYPositions,finalHeight] = trumpetPlot(xdata,ydata,writeNumber)
...
for i=1:numel(allAreas)
    ...
    patch(patchX,patchY,myColors(i,:),'LineWidth',1,'EdgeColor',[.7 .7 .7]);
